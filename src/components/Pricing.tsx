        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-stone-800 to-stone-900 rounded-3xl p-8 md:p-12 border border-stone-700 shadow-xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {currentPlan.prices.map((pricing, index) => (
                ...
                >
                  {index === 3 && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-green-500 text-white text-xs px-3 py-1 rounded-full font-bold whitespace-nowrap">
                      NAJPOVOLJNIJE
                    </div>
                  )}
                  <div className="text-gray-400 text-sm mb-2">{pricing.period}</div>
                  <div className={`text-3xl font-bold mb-4 ${
                    currentPlan.popular ? 'text-orange-400' : 'text-blue-400'
                  }`}>
                    {pricing.price}
                  </div>
                  <a
          ...
          <div className="text-center mt-8">
            <p className="text-gray-300">
              ...
              <a href="/kontakt" className="text-blue-400 font-semibold hover:underline">
